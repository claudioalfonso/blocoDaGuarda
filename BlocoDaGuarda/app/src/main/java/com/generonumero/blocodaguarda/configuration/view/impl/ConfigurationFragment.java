...
import com.generonumero.blocodaguarda.configuration.di.Injector;
...
public class ConfigurationFragment extends Fragment implements ConfigurationView {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Injector.inject(getContext(), this, this);

        configurationPresenter = new ConfigurationPresenterImpl(this, configurationRepository);
    }
